...
def train(args):
    ...
    for epoch in range(init_epoch,args.epoch):
        ...
        log.info(job='pcdseg',model=args.model_name,gpu=args.gpu, epoch=epoch, lr=lr)
        ...
        if save_model:
            fn_pth = 'pcdseg-%s-%.5f-%04d.pth' % (args.model_name, best_meaniou, epoch)
...
def evaluate(args):
    if args.model_name == 'pointnet':
        args.pretrain = 'checkpoints/pcdseg-pointnet-0.51023-0052.pth'
    else:
        args.pretrain = 'checkpoints/pcdseg-pointnet2-0.56290-0009.pth'
